...
<Aside title="Question">
  une **instance** par maison d'édition mais plusieurs **comptes** par instance.
  **OK pour le vocabulaire ?**
</Aside>

Oplibris offre la possibilité de créer des _comptes utilisateur_ pour chacun⋅e des collaborateur⋅rices de la maison d'édition. Dans la plupart des cas il s'agit de comptes d'employé⋅es mais il peut aussi s'agir de comptes d'utilisateur externe qui aurait besoin de voir plus de données que les données en rapport avec sa société (le comptable de la maison d'édition par exemple).
...
![67f86f0b-31e9-4644-abe0-c116def7e7c2.png](./images/utilisateurs1.png)

==COMMENTER TOUS LES ONGLETS==

<Aside title="Difficulté" type="danger">
  pas réussi à me connecter avec Identifiant/mdp → il y a besoin d'un mail
...
![67f86f0b-31e9-4644-abe0-c116def7e7c2.png](./images/utilisateurs2.png)
...
![67f86f0b-31e9-4644-abe0-c116def7e7c2.png](./images/utilisateurs3.png)
...
![67f86f0b-31e9-4644-abe0-c116def7e7c2.png](./images/utilisateurs4.png)
