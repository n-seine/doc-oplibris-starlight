...
La console éditeur `Doute sur la terminologie : à quoi correspond exactement la console éditeur? C'est l'interface OPlibris qu'on a ? ` est structurée autour de trois grands espaces regroupant les modules et fonctionnalités de l'outil en suivant la logique quotidienne d'une maison d'édition.
