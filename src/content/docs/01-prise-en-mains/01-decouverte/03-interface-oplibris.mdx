...
- **Toutes mes fonctionnalités:** Une page de l'accueil OPlibris qui liste l'ensemble des fonctionnalités de l'outil et permet d'y accéder.
- **Mes actualités OPlibris:** : Des informations utiles venant de l'équipe OPlibris : mises à jour, conseils, etc.
-
